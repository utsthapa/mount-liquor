...
export function HomeHero() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1200px] px-4 md:px-6 py-8 md:py-10 grid gap-6 lg:grid-cols-[1.2fr_1fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-4 font-serif text-[28px] leading-[1.1] sm:text-3xl lg:text-4xl">
          ...
          <div className="mt-5 flex flex-wrap gap-2.5">
            <Link
              ...
              className="inline-flex items-center rounded-full bg-white px-5 md:px-6 py-2.5 text-[11px] md:text-xs font-medium uppercase tracking-[0.2em] text-[color:var(--color-ink)] ring-1 ring-[color:var(--color-ink)]/20 shadow-sm hover:bg-[color:var(--color-bg)] transition-colors"
            >
              Shop Deals
            </Link>
            <Link
              href="/collections/whiskey"
              className="inline-flex items-center rounded-full border border-[color:var(--color-ink)]/15 bg-white/70 px-5 md:px-6 py-2.5 text-[11px] md:text-xs font-medium uppercase tracking-[0.2em] text-[color:var(--color-ink)] hover:bg-white transition-colors"
            >
              Browse Categories
            </Link>
          </div>
        ...
        <div className="relative mx-auto w-full max-w-[240px] sm:max-w-[280px] lg:max-w-[240px]">
          <div
            aria-hidden="true"
